...
const Hero = () => {
  return (
    <div style={{   marginTop:"70px",width:"100%",height:"100%",backgroundColor:"white",display:"flex",flexDirection:"row"}}>
 ...
 <div  style={{height:"100%",alignItems:"center",flexDirection:"column",display:"flex",gap:"2vh",paddingLeft:"10%",paddingTop:"4%"}}> 
  ...
  <div style={{display:"flex",justifyContent:"center",flexDirection:"column",fontWeight:"500"}}><img src="landing imgs/logo 1.png"/><p>AI Assistent</p></div>
  <div><img src='landing imgs/icon hirtage 1.png'/><p>Cultural Heritage</p></div>
  </div>
 </div>
